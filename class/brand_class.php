...
class brand{
	...
	public function insert_brand($cartgory_id,$brand_name){
		$query = "INSERT INTO tbl_brand (cartegory_id,brand_name) VALUES ('$cartgory_id','$brand_name')";
	...
	public function update_brand($cartgory_id,$brand_id,$brand_name){
