...
class sell{
	...
	public function insert_sell($user_id,$product_id,$product_name,$product_num){
		$query = "INSERT INTO tbl_sell (user_id,product_id,product_name,product_num) VALUES ('$user_id','$product_id','$product_name','$product_num')";
